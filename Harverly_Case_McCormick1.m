...
iter=1;
valueR=100;
Result=table(A,B,C,P,PX,PY,CX,CY,X,Y,profit,XP,XP1,XP2,prop,fy,fx,iter,valueR);
...
while iter<=1||valueR>=0.001
    ...
    fx=PX./P;
    iter=iter+1;
    Result1=table(A,B,C,P,PX,PY,CX,CY,X,Y,profit,XP,XP1,XP2,prop,fy,fx,iter,valueR);
